...
Start, stop, restart, suspend, or delete user containers
...
Access the SQL Lab application via the provided URL

Register a new account or log in

Start a personal MySQL container

Write and execute SQL queries in the browser

Explore schemas and preview tables
...
Manage user containers (start, stop, suspend, delete)
